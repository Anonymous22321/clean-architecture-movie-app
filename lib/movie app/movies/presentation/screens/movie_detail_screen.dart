...
import '../../../core/utilizes/movie_details_screen_mock_data.dart';
...
class MovieDetailContent extends GetView<MovieController> {
  const MovieDetailContent({super.key});

  @override
  Widget build(BuildContext context) {
    return Obx(() {
      if (controller.isLoading.value || controller.movieDetails.value == null) {
